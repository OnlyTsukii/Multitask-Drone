...
class Metaclass_Task(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if RawWaypoint.__class__._TYPE_SUPPORT is None:
                RawWaypoint.__class__.__import_type_support__()
...
class Task(metaclass=Metaclass_Task):
    ...
    _fields_and_field_types = {
        'waypoints': 'sequence<drone_interfaces/RawWaypoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['drone_interfaces', 'msg'], 'RawWaypoint')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, RawWaypoint) for v in value) and
                 True), \
                "The 'waypoints' field must be a set or sequence and each value of type 'RawWaypoint'"
