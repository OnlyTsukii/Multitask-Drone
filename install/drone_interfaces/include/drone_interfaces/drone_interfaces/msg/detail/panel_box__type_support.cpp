...
{
  new (message_memory) drone_interfaces::msg::PanelBox(_init);
}

void PanelBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<drone_interfaces::msg::PanelBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PanelBox_message_member_array[4] = {
  {
    ...
    offsetof(drone_interfaces::msg::PanelBox, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_interfaces::msg::PanelBox, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_interfaces::msg::PanelBox, w),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(drone_interfaces::msg::PanelBox, h),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PanelBox_message_members = {
  ...
  4,  // number of fields
  sizeof(drone_interfaces::msg::PanelBox),
...
{
  return &::drone_interfaces::msg::rosidl_typesupport_introspection_cpp::PanelBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, drone_interfaces, msg, PanelBox)() {
  return &::drone_interfaces::msg::rosidl_typesupport_introspection_cpp::PanelBox_message_type_support_handle;
}
