...
class PayloadController():
    def __init__(self):
        self.enable_cmd = f"echo {SYSTEM_PASSWORD} | sudo python /home/orangepi/Multitask-Drone/src/scripts/enable_payload.py"
        self.disable_cmd = f"echo {SYSTEM_PASSWORD} | sudo python /home/orangepi/Multitask-Drone/src/scripts/disable_payload.py"
