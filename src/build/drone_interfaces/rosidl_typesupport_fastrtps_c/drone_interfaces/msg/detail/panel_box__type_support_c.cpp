...
#include "drone_interfaces/msg/detail/panel_box__rosidl_typesupport_fastrtps_c.h"
...
using _PanelBox__ros_msg_type = drone_interfaces__msg__PanelBox;
...
size_t get_serialized_size_drone_interfaces__msg__PanelBox(
  const void * untyped_ros_message,
...
static uint32_t _PanelBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_interfaces__msg__PanelBox(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_drone_interfaces
size_t max_serialized_size_drone_interfaces__msg__PanelBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces__msg__PanelBox;
    is_plain =
      (
      offsetof(DataType, h) +
      last_member_size
...
static size_t _PanelBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_interfaces__msg__PanelBox(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, drone_interfaces, msg, PanelBox)() {
