...
#include "drone_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces::msg::Task;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const drone_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<drone_interfaces::msg::Task *>(
    untyped_ros_message);
...
{
  return &drone_interfaces::msg::typesupport_fastrtps_cpp::_Task__handle;
}
