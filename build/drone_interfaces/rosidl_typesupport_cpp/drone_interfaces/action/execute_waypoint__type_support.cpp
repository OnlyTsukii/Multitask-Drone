...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, drone_interfaces, action, ExecuteWaypoint_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<drone_interfaces::action::ExecuteWaypoint_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, drone_interfaces, action, ExecuteWaypoint_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<drone_interfaces::action::ExecuteWaypoint_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, drone_interfaces, action, ExecuteWaypoint)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<drone_interfaces::action::ExecuteWaypoint>();
}
