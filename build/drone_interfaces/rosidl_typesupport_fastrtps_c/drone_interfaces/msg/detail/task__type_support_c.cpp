...
#include "drone_interfaces/msg/detail/task__rosidl_typesupport_fastrtps_c.h"
...
#include "drone_interfaces/msg/detail/raw_waypoint__functions.h"  // waypoints
...
using _Task__ros_msg_type = drone_interfaces__msg__Task;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: waypoints
  {
    ...
    if (ros_message->waypoints.data) {
      drone_interfaces__msg__RawWaypoint__Sequence__fini(&ros_message->waypoints);
    }
...
static uint32_t _Task__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_drone_interfaces__msg__Task(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = drone_interfaces__msg__Task;
    is_plain =
      (
...
static size_t _Task__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_drone_interfaces__msg__Task(
