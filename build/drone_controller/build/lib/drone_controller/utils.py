...
def is_valid_mission(mission) -> bool:
    if not isinstance(mission, int):
        return False
    return mission == MISSION_NONE or mission == MISSION_LOCAL_CLEAN or mission == MISSION_GLOBAL_CLEAN or mission == MISSION_LOCAL_CAPTURE or mission == MISSION_LOCAL_TEST
